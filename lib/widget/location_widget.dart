  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: Text("$textPrefix${location.name}",
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: Theme.of(context).textTheme.bodySmall?.copyWith(
                    decoration: visited ? TextDecoration.lineThrough : TextDecoration.none, decorationThickness: 4)),
          ),
          ...
          Row(
            ...
            children: [
              if (onDelete != null)
                Material(
                  color: const Color(0xff27283D),
                  child: IconButton(onPressed: () => onDelete!(location), icon: const Icon(Icons.delete)),
                ),
