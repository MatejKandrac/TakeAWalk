...
initDependencies() async {
  ...
  di.registerFactory<ProfileBloc>(() => ProfileBloc(dio: di(), repository: di()));
  ...
  di.registerFactory<EventDetailBloc>(() => EventDetailBloc(authRepository: di(), repository: di(), dio: di()));
  ...
  di.registerLazySingleton<EventsRepository>(
      () => EventsRepositoryImpl(authRepository: di(), eventsApiService: di(), eventLocalService: di()));
